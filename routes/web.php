...
Route::get('searchPedidos', 'PedidoController@searchPedidos')->name('searchPedidos');
Route::get('searchEntregas', 'EntregaController@searchEntregas')->name('searchEntregas');
