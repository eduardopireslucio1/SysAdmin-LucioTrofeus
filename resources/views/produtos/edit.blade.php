                    ...
                    <form action="/admin/produtos/{{$models_produtos->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row" style="margin-bottom:6vh">
                            ...
                            <div class="col-3">
                                ...
                                <select name="status" id="status"
                                    ...
                                    <option value="1" {{$models_produtos->status == 1 ? "selected='selected'" : ""}}>
                                        Ativo
                                    </option>
                                    <option value="0" {{$models_produtos->status == 0 ? "selected='selected'" : ""}}>
                                        Inativo
                                    </option>
                                </select>
                                @error('status')
                        ...
                        <div class="row" style="margin-bottom:6vh">
                            ...
                            <div class="col-3">
                                ...
                                <input type="checkbox"
                                    {{in_array("Acrilico", $models_produtos->material) ? "checked=''" : ""}}
                                    name="material[]" value="Acrilico"
                                    class="form-control @error('material') is-invalid @enderror"
                                    id="material">Acrílico</input>
                                <input type="checkbox"
                                    {{in_array("MDF", $models_produtos->material) ? "checked=''" : ""}}
