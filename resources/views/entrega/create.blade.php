    ...
    <div class="row" style="margin-bottom:6vh">
        <div class="col-12">
            <div class="card card-success">
                ...
                <select class="custom-select form-control-border border-width-2" id="models_funcionario_id"
                ...
                <select class="custom-select form-control-border border-width-2" id="pedido_id"
                    placeholder="Selecione o pedido" class="selectpicker" data-live-search="true" style="width:100%">
                    <option data-valor="" value=""></option>
            ...
            <div class="col-4">
                ...
                <br><input class="form-control datetimepicker-input" id="dt_entrega" type="date"
